...
Revision ID: a5a5870e99e0
Revises: 0cd6ce59252c
Create Date: 2022-08-20 21:57:23.294631
...
def downgrade():
    ...
    sa.Column('website_link', sa.VARCHAR(), autoincrement=False, nullable=False),
